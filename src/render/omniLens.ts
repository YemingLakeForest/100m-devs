...
import { ladderShrink } from '../sim/ladder.ts'
...
export function fitScale(
  ...
  // **The dolly rate comes from the ladder, not from a curve.** See
  // `ladderShrink` — one rung out is ten times the people, which is √10 times
  // the linear size, and the curve this replaced said 1.2.
  return fit * ladderShrink(z, stopZ)
}
